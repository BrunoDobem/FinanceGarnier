    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="col-span-3 md:col-span-1 animate-fade-in">
          <CardHeader>
            <CardTitle>{t("total_cash_expenses")}</CardTitle>
            <CardDescription>{t("this_months_cash_spending")}</CardDescription>
          </CardHeader>
        ...
        <Card className="col-span-3 md:col-span-2 animate-fade-in animation-delay-100">
          <CardHeader>
            ...
            <CardDescription>{t("how_cash_expenses_are_distributed")}</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card className="animate-fade-in animation-delay-200">
        <CardHeader>
          <CardTitle>{t("recent_cash_expenses")}</CardTitle>
          <CardDescription>{t("your_one_time_cash_payments")}</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <SearchInput
            ...
            <div className="rounded-md border">
              {filteredCashExpenses.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center p-8 text-center animate-fade-in">
                  ...
                  <h3 className="text-lg font-semibold">{t("no_cash_expenses")}</h3>
                  <p className="text-sm text-muted-foreground max-w-sm mt-1">
                    {t("no_cash_expenses_description")}
                  </p>
                </div>
              )}
            </div>
