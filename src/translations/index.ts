...
export type TranslationKey =
  ...
  | "upcoming_payments"
  | "next_subscription_charges"
  | "manage_recurring_payments"
  | "all_credit_expenses"
  | "total_cash_expenses"
  | "this_months_cash_spending"
  | "expenses_by_category"
  | "how_cash_expenses_are_distributed"
  | "recent_cash_expenses"
  | "your_one_time_cash_payments";
...
export const ptBR_translations: Translation = {
  ...
  monthly_subscriptions: "Gasto Fixo Mensais",
  add_subscription: "Adicionar Gasto Fixo",
  manage_subscriptions: "Gerenciar Gasto Fixo",
  all_subscriptions: "Todas as Gasto Fixo",
  ...
  total: "Total",
  actions: "Ações",
  subscription_added: "Gasto Fixo adicionada com sucesso",
  subscription_deleted: "Gasto Fixo excluída com sucesso",
  weekly: "Semanal",
  monthly: "Mensal",
  ...
  no_subscriptions: "Nenhuma Gasto Fixo",
  no_subscriptions_description: "Você ainda não tem nenhuma Gasto Fixo cadastrada",
  ...
  search_subscriptions: "Pesquisar Gasto Fixo...",
  ...
  total_monthly_subscriptions: "Suas Gasto Fixo mensais totais",
  upcoming_payments: "Pagamentos Futuros",
  next_subscription_charges: "Seus próximos encargos de Gasto Fixo",
  manage_recurring_payments: "Gerencie seus pagamentos mensais recorrentes",
  all_credit_expenses: "Todas as Despesas no Crédito",
  total_cash_expenses: "Total de Despesas em Dinheiro",
  this_months_cash_spending: "Gastos em Dinheiro deste Mês",
  expenses_by_category: "Despesas por Categoria",
  how_cash_expenses_are_distributed: "Como suas despesas em dinheiro estão distribuídas",
  recent_cash_expenses: "Despesas Recentes em Dinheiro",
  your_one_time_cash_payments: "Seus pagamentos únicos em dinheiro",
  add_cash_expense: "Adicionar Despesa em Dinheiro",
  no_cash_expenses: "Nenhuma despesa em dinheiro",
  no_cash_expenses_description: "Você ainda não tem nenhuma despesa em dinheiro cadastrada",
  income_deleted: "Receita excluída com sucesso",
  income_deleted_description: "A entrada de receita foi removida",
  add_income_description: "Adicione uma nova fonte de receita",
  add_cash_expense_description: "Adicione uma nova despesa em dinheiro",
  edit_income_description: "Modifique os detalhes da receita",
...
export const enUS_translations: Translation = {
  ...
  total_monthly_subscriptions: "Your total monthly subscriptions",
  upcoming_payments: "Upcoming Payments",
  next_subscription_charges: "Your next subscription charges",
  manage_recurring_payments: "Manage your recurring payments",
  all_credit_expenses: "All Credit Expenses",
  total_cash_expenses: "Total Cash Expenses",
  this_months_cash_spending: "This month's cash spending",
  expenses_by_category: "Expenses by Category",
  how_cash_expenses_are_distributed: "How your cash expenses are distributed",
  recent_cash_expenses: "Recent Cash Expenses",
  your_one_time_cash_payments: "Your one-time cash payments",
  track_your_income_sources: "Acompanhe suas fontes de renda",
  total_income: "Total de Receitas",
  this_months_total_earnings: "Receitas deste mês",
  income_by_category: "Receitas por Categoria",
  your_income_distribution: "Distribuição de suas receitas",
  income_entries: "Entradas de Receitas",
  your_income_sources_and_amounts: "Suas fontes de receita e valores",  
  no_income_entries: "Nenhuma entrada de receita",
  no_income_entries_description: "Você ainda não tem nenhuma entrada de receita cadastrada",
...
export const esES_translations: Translation = {
  ...
  total_monthly_subscriptions: "Tus suscripciones mensuales totales",
  upcoming_payments: "Pagos Futuros",
  next_subscription_charges: "Tus próximos cargos de suscripción",
  manage_recurring_payments: "Gestiona tus pagos recurrentes",
